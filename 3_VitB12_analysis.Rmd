...
sum(test_df_CD$VALUE == ">1400") / dim(test_df_CD)[1]
sum(test_df_UC$VALUE == ">1400") / dim(test_df_UC)[1]
...
#Look at distribution:
 p1 <-  ggplot(test_df_CD)+
    geom_histogram(aes(x=as.numeric(VALUE)), bins=30) + theme_classic()+ylab("Count") + xlab("Vitamin B12")
 p2 <-  ggplot(test_df_CD)+
    geom_histogram(aes(x=log(as.numeric(VALUE)+1)), bins=30)+ theme_classic()+ylab("Count") + xlab("Vitamin B12 - log transformed")
...
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/VitB12_restable_CD_onlyGP.txt", quote=F, row.names=F)

p <- ggplot(data=test_df_CD)+
    geom_boxplot(aes(x=as.factor(time_interval), y=measure_transformed, color=IBD))+
    ggtitle("Crohn's Disease: Vitamin B12")+theme_classic()+xlab("Years before diagnosis")+ylab("Measure (log transformed)")
...
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/VitB12_restable_UC_onlyGP.txt", quote=F, row.names=F)

q <- ggplot(data=test_df_UC)+
    geom_boxplot(aes(x=as.factor(time_interval), y=measure_transformed, color=IBD))+
    ggtitle("Ulcerative colitis: Vitamin B12")+theme_classic()+xlab("Years before diagnosis")+ylab("Measure (log transformed)")
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/One_VitB12_restable_CD_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/One_VitB12_restable_UC_onlyGP.txt", quote=F, row.names=F)
```
...
res
write.table(res, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/VitaminB12_UC_vs_CD_onlyGP.txt", quote=F, row.names=F)
```
...
```{r}
test_df_CD <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Sensitivity_VitB12_CD_onlyGP.txt", sep=" ")
test_df_UC <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Sensitivity_VitB12_UC_onlyGP.txt", sep=" ")
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Sensitivity_VitB12_restable_CD_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Sensitivity_VitB12_restable_UC_onlyGP.txt", quote=F, row.names=F)
...
```{r}
test_df_CD <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/VitB12_CD_comorb_onlyGP.txt", sep=" ")
test_df_UC <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/VitB12_UC_comorb_onlyGP.txt", sep=" ")
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/VitB12_restable_CD_comorb_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/VitB12_restable_UC_comorb_onlyGP.txt", quote=F, row.names=F)
