...
sum(test_df_CD$VALUE == "<0.02") / dim(test_df_CD)[1]
sum(test_df_UC$VALUE == "<0.02") / dim(test_df_UC)[1]
...
#Look at distribution:
 p1 <-  ggplot(test_df_CD)+
    geom_histogram(aes(x=as.numeric(VALUE)), bins=30) + theme_classic()+ylab("Count") + xlab("Basophiles")
 p2 <-  ggplot(test_df_CD)+
    geom_histogram(aes(x=sqrt(as.numeric(VALUE))), bins=30)+ theme_classic()+ylab("Count") + xlab("Basophiles - sqrt transformed")
 ...
 ggplot()+
    geom_histogram(aes(x=sqrt(as.numeric(c(test_df_CD$VALUE, test_df_UC$VALUE)))), bins=30)+ theme_classic()+ylab("Count") + xlab("Basophiles - sqrt transformed")
...
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Basofile_restable_CD_onlyGP.txt", quote=F, row.names=F)

p <- ggplot(data=test_df_CD)+
    geom_boxplot(aes(x=as.factor(time_interval), y=measure_transformed, color=IBD))+
    ggtitle("Crohn's Disease: Basophiles")+theme_classic()+xlab("Years before diagnosis")+ylab("Measure (sqrt transformed)")
...
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Basofile_restable_UC_onlyGP.txt", quote=F, row.names=F)

q <- ggplot(data=test_df_UC)+
    geom_boxplot(aes(x=as.factor(time_interval), y=measure_transformed, color=IBD))+
    ggtitle("Ulcerative colitis: Basophiles")+theme_classic()+xlab("Years before diagnosis")+ylab("Measure (sqrt transformed)")
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/One_Basofile_restable_CD_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/One_Basofile_restable_UC_onlyGP.txt", quote=F, row.names=F)
```
...
res
write.table(res, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Basophiles_UC_vs_CD_onlyGP.txt", quote=F, row.names=F)
```
...
```{r}
test_df_CD <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Sensitivity_Basophiles_CD_onlyGP.txt", sep=" ")
test_df_UC <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Sensitivity_Basophiles_UC_onlyGP.txt", sep=" ")
...
#Look at distribution:
  ...
  ggplot(test_df_UC)+
    geom_histogram(aes(x=as.numeric(VALUE)), bins=30)
  ggplot(test_df_UC)+
    geom_histogram(aes(x=sqrt(as.numeric(VALUE)+1)), bins=30)
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Sensitivity_Basofile_restable_CD_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Sensitivity_Basofile_restable_UC_onlyGP.txt", quote=F, row.names=F)
...
```{r}
test_df_CD <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Basophiles_CD_comorb_onlyGP.txt", sep=" ")
test_df_UC <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Basophiles_UC_comorb_onlyGP.txt", sep=" ")
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Basofile_restable_CD_comorb_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Basofile_restable_UC_comorb_onlyGP.txt", quote=F, row.names=F)
