...
#Look at distribution:
 p1 <-  ggplot(test_df_CD)+
    geom_histogram(aes(x=as.numeric(VALUE)), bins=30) + theme_classic()+ylab("Count") + xlab("Eosinophiles")
 p2 <-  ggplot(test_df_CD)+
    geom_histogram(aes(x=sqrt(as.numeric(VALUE))), bins=30)+ theme_classic()+ylab("Count") + xlab("Eosinophiles - sqrt transformed")
 ...
 ggplot()+
    geom_histogram(aes(x=sqrt(as.numeric(c(test_df_CD$VALUE, test_df_UC$VALUE)))), bins=30)+ theme_classic()+ylab("Count") + xlab("Eosinophiles - sqrt transformed")
  
#Transform when necessary -> make a new column (measure_transformed)
test_df_CD$measure_transformed <- sqrt(as.numeric(test_df_CD$VALUE))
test_df_UC$measure_transformed <- sqrt(as.numeric(test_df_UC$VALUE))
...
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Eosinophiles_restable_CD_onlyGP.txt", quote=F, row.names=F)

p <- ggplot(data=test_df_CD)+
    geom_boxplot(aes(x=as.factor(time_interval), y=measure_transformed, color=IBD))+
    ggtitle("Crohn's Disease: Eosinophiles")+theme_classic()+xlab("Years before diagnosis")+ylab("Measure (sqrt transformed)")
...
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Eosinophiles_restable_UC_onlyGP.txt", quote=F, row.names=F)

q <- ggplot(data=test_df_UC)+
    geom_boxplot(aes(x=as.factor(time_interval), y=measure_transformed, color=IBD))+
    ggtitle("Ulcerative colitis: Eosinophiles")+theme_classic()+xlab("Years before diagnosis")+ylab("Measure (sqrt transformed)")

ggarrange(p, q)

```

Sensitvity: Running the models only including one time point pr. case person:
```{r}
library(data.table)
#CD:
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/One_Eosinophile_restable_CD_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/One_Eosinophile_restable_UC_onlyGP.txt", quote=F, row.names=F)
```
...
res
write.table(res, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Eosinophiles_UC_vs_CD_onlyGP.txt", quote=F, row.names=F)
```


## Sensitivity analysis: 2 IBD diagnoses
```{r}
test_df_CD <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Sensitivity_Eosinophiles1_CD_onlyGP.txt", sep=" ")
test_df_UC <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Sensitivity_Eosinophiles1_UC_onlyGP.txt", sep=" ")
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Sensitivity_Eosinophiles_restable_CD_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Sensitivity_Eosinophiles_restable_UC_onlyGP.txt", quote=F, row.names=F)

```

## Comorb sensitivity analysis:
```{r}
test_df_CD <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Eosinophiles1_CD_comorb_onlyGP.txt", sep=" ")
test_df_UC <- read.csv("F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/Eosinophiles1_UC_comorb_onlyGP.txt", sep=" ")
...
colnames(res_CD)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_CD
write.table(res_CD, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Eosinophiles_restable_CD_comorb_onlyGP.txt", quote=F, row.names=F)
...
colnames(res_UC)[1:5] <- c("Estimate", "SE", "df", "t_value", "p_value")
res_UC
write.table(res_UC, "F:/Projekter/FSEID00001565/Data/Subprojects/Marie_IBD_clinical_biomarker/results/Eosinophiles_restable_UC_comorb_onlyGP.txt", quote=F, row.names=F)
